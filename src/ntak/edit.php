              ...
              <div class="row gx-5 gy-5">
                ...
                <div class="col">
                  ...
                  <select id="arrival_date" name="arrival_date" class="form-select">
                    <option value=""></option>
                    <option value="27" <?= (getEscapedValue('arrivalDate', $contact) == ContactRepository::DATE_PREFIX . '27' ? 'selected' : '') ?>>2021. augusztus 27.
                      péntek
                    </option>
                    <option value="28" <?= (getEscapedValue('arrivalDate', $contact) == ContactRepository::DATE_PREFIX . '28' ? 'selected' : '') ?>>2021. augusztus 28.
                      szombat
                    </option>
                  </select>
                </div>
                <div class="col">
                  ...
                  <select id="departure_date" name="departure_date" class="form-select">
                    <option value=""></option>
                    <option value="28" <?= (getEscapedValue('departureDate', $contact) == ContactRepository::DATE_PREFIX . '28' ? 'selected' : '') ?>>2021. augusztus 28.
                      szombat
                    </option>
                    <option value="29" <?= (getEscapedValue('departureDate', $contact) == ContactRepository::DATE_PREFIX . '29' ? 'selected' : '') ?>>2021. augusztus 29.
                      vasárnap
                    </option>
                  </select>
                </div>
